...
<head>
    ...
    <link rel="stylesheet" href="../css/media-query/main-contato.css">
...
<body id="body" onload="preLoading()">
    ...
    <section id="pesquisa-section-iframe" class="container">
        <iframe   iframe  src="../iframe/barra-pesquisa.php" frameborder="0">aa</iframe>
    </section>
...
<section id="" class="btns-carrinho">
    ...
    <main class="container">
        ...
        <section class="section-banner-titulo-main">
            <h2 class="xgain-title">FALE CONOSCO</h2>
        </section>
        <p class="text-avisinho">*Caso necessite de assistência ou informações adicionais, por gentileza, não hesite em entrar em contato com a nossa central de atendimento. De já, obrigado!</p>
        <section class="section-contato">

            <section class="section-info-redes-sociais">
                <div class="area-info">
                    <h2>INFO</h2>
            ...
            <section class="section-forms-contato">
                <div class="area-aviso-contato" id="area-aviso-contato">
                    <i id="exit-aviso-section-contato" class="btn-sair" title="Sair">
                        <svg version="1.1" viewBox="0 0 510.82 510.82" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><g transform="translate(6254.9 1860.8)">
                        <g transform="translate(37.2 -34.339)" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <p class="erro" id="tituloNotificacao">--ERRO--</p>
                ...
                <form action="" method="post" class="form-contato" id="form-contato">
                    ...
                    <input type="text" name="nome" id="nomeContato" placeholder="Seu nome" class="inputs-contato" oninput="copyInformacoes()">
                    <label for="">E-mail</label>
                    <input type="email" name="emailContato" id="emailContato" placeholder="nome.sobrenome@email.com" class="inputs-contato" oninput="copyInformacoes()">
                    <label for="">Número</label>
                    <input type="tel" name="telefoneContato" id="telefoneContato" placeholder="(xx) xxxx-xxxx" class="inputs-contato" oninput="copyInformacoes()">
                    <label for="">Mensagem</label>
                    <textarea name="mansagem" id="mensagemContato" placeholder="Descreva o assunto" class="inputs-contato" oninput="copyInformacoes()"></textarea>
                    <!-- <button type="button" onclick="verificarFormsContato()">Enviar mensagem</button> -->
                </form>
                <form action="https://formsubmit.co/00cf4b41ffabdc7599938aa558d10733" method="POST" class="form-contato" id="form-contato-copy">
                    <input type="hidden" name="_next" value="http://127.0.0.1:5500/telas/contato.php?envio=true">
                    <input type="hidden" name="_cc" value="tcc.etec.ultimate.challenge@gmail.com">
                    <input type="text" name="name" id="copyNomeContato" placeholder="Seu nome" class="" style="display: none;">
                    <input type="email" name="email" id="copyEmailContato" placeholder="nome.sobrenome@email.com" class="" style="display: none;">
                    <textarea name="message" id="copyMensagemContato" placeholder="Descreva o assunto" class="" style="display: none;"></textarea>
                    <button type="submit" id="enviarMensagemContato">Enviar mensagem</button>

                    <!-- <input type="hidden" name="_autoresponse" value="Olá recebemos a sua mensagem! Entraremos em contato em até 72h, fique atento em sua caixa de e-mail"> -->
...
<script src="../Js/main-contato.js"></script>
