...
<head>
    ...
    <link rel="stylesheet" href="./css/media-query/main-home.css">

    <script src="https://unpkg.com/gltf-js-utils@1.2.1/dist/gltf-js-utils.min.js"></script>
...
<section id="" class="btns-carrinho">
    ...
    <section id="header-mobile" class="header-mobile">
        ...
        <section class="item-header-mobile"><a href="./telas/resultados.php?buscar=categoria&cat=Cárdio">CARDIO</a></section>
        <section class="item-header-mobile"><a href="./telas/resultados.php?buscar=categoria&cat=Musculação">MUSCULAÇÃO</a></section>
        <section class="item-header-mobile"><a href="./telas/resultados.php?buscar=categoria&cat=Acessórios">ACESSÓRIOS</a></section>
        <section class="item-header-mobile"><a href="./telas/sobre.php">SOBRE</a></section>
        <section class="item-header-mobile"><a href="./telas/contato.php">CONTATO</a></section>
    </section>
    ...
    <header id="myHeader">
        <section class="left-header text-left-header">
            ...
            <section class="item-header" id="categoria-cardio">
                <a href="./telas/resultados.php?buscar=categoria&cat=Cárdio" >CÁRDIO</a>
                <div id="list-cardio" class="list-itens-header">
                    <ul>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Esteira">ESTEIRA</a></li>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Escada">ESCADA</a></li>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Bike">BIKE</a></li>
                    </ul>
                </div>
            </section>

            <section class="item-header" id="categoria-musculacao">
                <a href="./telas/resultados.php?buscar=categoria&cat=Musculação">MUSCULAÇÃO</a>
                <div id="list-musculacao" class="list-itens-header">
                    <ul>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Abdômen">ABDÔMEN</a></li>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Braço">BRAÇO</a></li>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Costas">COSTAS</a></li>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Ombro">OMBRO</a></li>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Peito">PEITO</a></li>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Perna">PERNA</a></li>
                    </ul>
                </div>
            </section>
            <section class="item-header" id="categoria-acessorios">
                <a href="./telas/resultados.php?buscar=categoria&cat=Acessórios">ACESSÓRIOS</a>
                <div id="list-acessorios" class="list-itens-header">
                    <ul>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Utilitários">UTILITÁRIOS</a></li>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Equipamentos">EQUIPAMENTOS</a></li>
                        <li><a href="./telas/resultados.php?buscar=categoria&subcat=Outros">OUTROS</a></li>
                    </ul>
                </div>
            </section>
        </section>
        ...
        <section class="right-header text-right-header">
            ...
            <div class="item-header"><a href="./telas/sobre.php">SOBRE</a></div>
            <div class="item-header"><a href="./telas/contato.php">CONTATO</a></div>
                ...
                <div class="header-perfil">
                    ...
                    <div class="area-list-perfil">
                        ...
                        <ul class="list-perfil logado" id="logado">
                            <li><a href="./telas/perfil.php" id="header-nome-perfil" title=""><?php echo $_SESSION['User']['nome']." ".$_SESSION['User']['sobrenome']?></a></li>
    ...
    <main class="container">
        ...
        <section class="section-banner-home">
            <div class="banner-home">
                ...
                <!-- Imagens que serão os banners -->
                <div class="banners-img" id="banners-img">
                ...
                <div class="btns-setinha-banner-home" id="btns-setinha-banner-home">
                    <i id="btn-setinha-banner-E" class="btn-setinha-banner btn-setinha-banner-E">
                        <i class="control-btn-setinha control-btn-setinha-E"></i>
                        <svg class="btn-setinha-banner-E" version="1.1" viewBox="0 0 378.44 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><g transform="translate(9646.9 1806.7)"><g transform="matrix(14.08 0 0 14.08 -10207 -1154.8)"><g transform="matrix(.96856 0 0 .96856 39.045 -51.848)"><path d="m27.513 42.273-25.752-17.773 25.752-17.773c-4.6295 5.3561-8.6143 10.991-8.6143 17.265 0 6.7856 4.1164 13.922 8.6143 18.281z"/><path d="m27.863 5.791a1.0001 1.0001 0 0 0-0.91797 0.11328l-25.752 17.773a1.0001 1.0001 0 0 0 0 1.6445l25.752 17.773a1.0001 1.0001 0 0 0 1.2637-1.541c-4.3251-4.1912-8.3105-11.181-8.3105-17.562 0-5.8496 3.7828-11.303 8.3711-16.611a1.0001 1.0001 0 0 0-0.40625-1.5898zm-5.1328 5.4512c-2.7739 3.9394-4.832 8.1256-4.832 12.75 0 4.8082 1.9735 9.586 4.6289 13.625l-19.008-13.117z"/></g></g></g></svg>
                    </i>
                    <i id="btn-setinha-banner-D" class="btn-setinha-banner btn-setinha-banner-D">
                        <i class="control-btn-setinha control-btn-setinha-D"></i>
                ...
                <div class="btns-bolinha-banner-home">
                    <!-- <i id="btn-bolinha-banner" class="btn-bolinha-banner banner-foco"></i> -->
                </div>
            </div>
            <div class="saibaMais-banner">
            <button id="btn-saiba-mais" class="btn-saiba-mais" onclick="SaibaMais()"><a href="./telas/resultados.php?buscar=categoria">SAIBA MAIS</a></button>
            <script>
                    function SaibaMais(){
                        window.location.href = './telas/resultados.php?buscar=categoria'
                    }
            </script>
            </div>
        </section>
                                                            ...
                                                            <!-- Categorias -->
        <section class="section-categorias-main-home">
            <button id="btn-categoria-cardio" class="btn-categoria-home">CÁRDIO</button>
            <button id="btn-categoria-musculacao" class="btn-categoria-home">MUSCULAÇÃO</button>
            <button id="btn-categoria-acessorios" class="btn-categoria-home">ACESSÓRIOS</button>
        </section>

                                                            <!-- Produtos em destaque -->
        <section id="" class="section-produtos-destaque-home">
            <h2>EM DESTAQUE</h2>
            <h3>LINHA DE MUSCULAÇÃO</h3>

            <div class="amostra-produtos-linha">
                <img class="area-img-produto-destaque" src="./imgs/produtos/6563bb5b2e517_LegPress 3-4.png" alt=""></img>
                <div class="right-amostra-produtos-linha">
                    <p id="" class="descricao-produto-destaque">
                        A musculação é uma das modalidades mais populares de exercício físico, e seus aparelhos desempenham um papel fundamental no treinamento de força e hipertrofia muscular. Essa categoria de equipamentos é projetada para proporcionar aos praticantes de musculação uma variedade de opções e exercícios que visam o desenvolvimento hipertrófico e o fortalecimento dos músculos.
                    </p>

                    <div class="outros-linha">
                        <a id="outros-da-linha" href="./telas/resultados.php?buscar=categoria&cat=musculacao" id="">OUTROS DA LINHA</a>
                        <div class="produtos-outros-linha">
                            <a href="./telas/produto.php?idProd=7" id=""><img src="./imgs/produtos/6563c37934652_Flexora 3_4.png" alt="Produto 1" title="Produto 1" id="produto-1" class="img-produto-galery"></a><!-- Aqui e o id ou o nome da imagem produto -->
                            <a href="./telas/produto.php?idProd=8" id=""><img src="./imgs/produtos/6563c420770ba_extensora 3_4.png"  alt="Produto 2" title="Produto 2"  id="produto-2" class="img-produto-galery"></a>
                            <a href="./telas/produto.php?idProd=3" id=""><img src="./imgs/produtos/6563bb0f2f00d_panturrilha 3_4.png" alt="Produto 3" title="Produto 3" id="produto-3" class="img-produto-galery"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="" class="section-produtos-destaque-home">
            <h2>EM DESTAQUE</h2>
            <h3>LINHA DE CÁRDIO</h3>

            <div class="amostra-produtos-linha">
                <img class="area-img-produto-destaque" src="./imgs/produtos/6563ba87a3c32_Simulador de escada 3_4.png" alt="" ></img>
                <div class="right-amostra-produtos-linha">
                    <p id="" class="descricao-produto-destaque">
                        Os aparelhos dessa categoria são uma modalidade de exercícios que visam fortalecer o sistema cardíaco, os pulmões e os músculos por meio de atividades físicas que testam sua resistência e movimentam o corpo inteiro
                    </p>

                    <div class="outros-linha">
                        <a id="outros-da-linha" href="./telas/resultados.php?buscar=categoria&cat=Cárdio" id="">OUTROS DA LINHA</a>
                        <div class="produtos-outros-linha">
                            <a href="./telas/produto.php?idProd=2" id=""><img src="./imgs/produtos/6563ba87a3c32_Simulador de escada 3_4.png" alt="Produto 1" title="Produto 1" id="produto-1" class="img-produto-galery"></a><!-- Aqui e o id ou o nome da imagem produto -->
                            <a href="./telas/produto.php?idProd=9" id=""><img src="./imgs/produtos/6563c48e83495_Esteira curvada 3_4.png"  alt="Produto 2" title="Produto 2"  id="produto-2" class="img-produto-galery"></a>
                            <a href="./telas/produto.php?idProd=11" id=""><img src="./imgs/produtos/6563d177c050f_1 Esteira 3-4.png" alt="Produto 3" title="Produto 3" id="produto-3" class="img-produto-galery"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="" class="section-produtos-destaque-home">
            <h2>EM DESTAQUE</h2>
            <h3>LINHA DE ACESSÓRIOS</h3>

            <div class="amostra-produtos-linha">
                <img class="area-img-produto-destaque" src="./imgs/produtos/6563e268b6c0a_1 Sneakers 3-4.png" alt=""></img>
                <div class="right-amostra-produtos-linha">
                    <p id="" class="descricao-produto-destaque">
                        Os produtos dessa categoria visam possibilitar, auxiliar e facilitar a execução de um exercício, nessa categoria os produtos vão de halteres, bancos, colchonetes, á bolsas, toalhas, strap, faixas de compressão, cinturões de musculação entre outros.
                    </p>

                    <div class="outros-linha">
                        <a id="outros-da-linha" href="./telas/resultados.php?buscar=categoria&cat=Acessórios" id="">OUTROS DA LINHA</a>
                        <div class="produtos-outros-linha">
                            <a href="./telas/produto.php?idProd=5" id=""><img src="./imgs/produtos/6563bcefd9873_Hand grip  3 4 .png" alt="Produto 1" title="Produto 1" id="produto-1" class="img-produto-galery"></a><!-- Aqui e o id ou o nome da imagem produto -->
                            <a href="./telas/produto.php?idProd=6" id=""><img src="./imgs/produtos/6563c2c725f4d_1 3-4 halter.png"  alt="Produto 2" title="Produto 2"  id="produto-2" class="img-produto-galery"></a>
                            <a href="./telas/produto.php?idProd=14" id=""><img src="./imgs/produtos/6563d557c01ec_barra fixa 3 4.png" alt="Produto 3" title="Produto 3" id="produto-3" class="img-produto-galery"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section-sobre-home">
            <div class="title-sobre"><h2 class="">SOBRE</h2><h2 class="title-sobre-xgain">X gain</h2></div>
            <div class="main-sobre-home">
                <div class="texto-sobre">
                    <p>
                        A X-Gain é uma empresa fictícia inovadora e autônoma, criada para fins ilustrativos, que surge no cenário comercial com a determinação de competir com grandes marcas consolidadas. Fundada por um grupo fictício de três visionários estudantes, nossa narrativa busca apresentar o propósito de fornecer equipamentos fictícios de alta qualidade com um excelente custo-benefício, ajudando nossos clientes a alcançar o sucesso em seus negócios imaginários.
                    </p>
                    <p>
                        Seja bem-vindo à X-Gain, onde a inovação, qualidade e comprometimento com a satisfação do cliente estão no centro de tudo o que fazemos. Junte-se a nós nessa jornada de sucesso para transformar seus negócios com nossos equipamentos excepcionais.
                    </p>
                </div>

                <div class="img-sobre">
                    <!-- <img src="./imgs/banner-sobre-home.jpg" alt="Foto da equipe"> -->
                </div>
            </div>
        </section>

                                                            <!-- Banner de cadastro -->
        <section class="section-banner-cadastro">
            <div class="banner-cadastro">
                <i class="logo-horizontal-vertical">
    ...
    <footer>
        ...
        <section class="end-footer container">
            <a href="#Home"><i id="icon-logo-footer" title="Logo, clique para subir para o topo da pagina"><svg version="1.1" viewBox="0 0 514.16 314.73" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><g transform="matrix(3.3284 0 0 3.3284 -14854 -1506.8)">
...
<script src="./Js/banner-home.js" defer></script>
