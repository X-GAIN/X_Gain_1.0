...
<head>
    ...
    <link rel="stylesheet" href="../css/media-query/main-sobre.css">
...
<body id="body" onload="preLoading()">
    ...
    <div id="topo"></div>
                                                            ...
                                                            <!-- Login || Cadastro -->
    <section class="section-login-cadastro" id="section-login-cadastro">
...
<section id="" class="btns-carrinho">
    ...
    <main class="container">
        ...
        <section class="section-banner-titulo-main">
            <i class="icon-logo-sobre" title="logo">
                <svg version="1.1" viewBox="0 0 514.16 314.73" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><g transform="matrix(3.3284 0 0 3.3284 -14854 -1506.8)">
                    <path alt="logo do site, clique para subir até o topo da página" transform="translate(976.43,-7.7164)" d="m3540.4 553.19-33.732-0.0426-18.533-23.68 0.03-24.933 39.806 0.0204-14.475 15.52-0.2235 0.22443 10.251 13.077 23.143-26.962-16.234-18.4-18.802-0.025-23.451-25.721 53.76-0.0312 21.638 24.421 21.624-24.421 53.76 0.0312-23.451 25.721-18.802 0.025-16.234 18.4 23.143 26.962 10.251-13.077-0.2236-0.22443-14.475-15.52 39.806-0.0204 0.03 24.933-18.533 23.68-33.732 0.0426-23.158-26.958z" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.6053" style="font-variation-settings:'wght' 400;paint-order:normal"/></g>
                </svg>
            </i>
            <h2 class="xgain-title">x gain</h2>
        </section>
        <section class="section-sobre-nos" >
            ...
            <div class="area-sobre-nos">
                ...
                <p class="text-sobre">
                    A X-Gain é uma empresa fictícia inovadora e autônoma, criada para fins ilustrativos, que surge no cenário comercial com a determinação de competir com grandes marcas consolidadas. Fundada por um grupo de três estudantes, nossa narrativa busca apresentar o propósito de fornecer equipamentos fictícios de alta qualidade com um excelente custo-benefício, ajudando nossos clientes a alcançar o sucesso em seus negócios.
                </p>
            </div>
            <div class="area-como">
                <h2 class="titulo-como">COMO</h2>
                <p class="text-como">
                    Com uma abordagem única, a X-Gain é uma criação para se destacar nesse mercado, oferecendo soluções eficientes e confiáveis para atender às necessidades de nossos clientes. Nossa equipe trabalha incansavelmente para garantir que cada produto fictício que produzimos atenda aos mais altos padrões de qualidade e desempenho.
                    <br>Nossa "empresa" acredita que a satisfação do cliente é a chave para o nosso crescimento contínuo na trama, e é por isso que colocamos a excelência no atendimento em primeiro lugar.
                    <br>Estamos sempre prontos para ouvir os feedbacks e sugestões de nossos clientes, buscando constantemente aprimorar nossos produtos e serviços.
                </p>
            </div>
            <div class="area-desafios">
                <h2 class="titulo-desafios">DESAFIOS</h2>
                <p class="text-desafios">
                    Como uma "empresa" nova no mercado, estamos cientes dos desafios que enfrentamos, mas encaramos cada obstáculo como uma oportunidade para crescer e aprender na trama. Com a "confiança" de nossos clientes e o "apoio" contínuo de nossa equipe talentosa, estamos "confiantes" de que a X-Gain continuará a "prosperar" e alcançar novos patamares na história.
                </p>
            </div>
            <div class="area-bem-vindo">
                <h2 class="titulo-bem-vindo">BEM VINDO</h2>
